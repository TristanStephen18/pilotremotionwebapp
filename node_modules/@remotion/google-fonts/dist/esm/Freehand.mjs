...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/freehand/v33/cIf-Ma5eqk01VjKTgDmNRGQ-mQ.woff2",
        latin: "https://fonts.gstatic.com/s/freehand/v33/cIf-Ma5eqk01VjKTgDmGRGQ.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]

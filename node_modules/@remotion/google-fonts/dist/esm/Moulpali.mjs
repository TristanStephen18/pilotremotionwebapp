...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        khmer: "https://fonts.gstatic.com/s/moulpali/v32/H4ckBXKMl9HagUWymxY2yL6Agw.woff2",
        latin: "https://fonts.gstatic.com/s/moulpali/v32/H4ckBXKMl9HagUWymxY9yL4.woff2"
      }
    }
  },
  subsets: ["khmer", "latin"]

...
var getInfo = () => ({
  ...
  fonts: {
    normal: {
      "400": {
        "latin-ext": "https://fonts.gstatic.com/s/ranchers/v18/zrfm0H3Lx-P2Xvs2ArDRBi_NXQ.woff2",
        latin: "https://fonts.gstatic.com/s/ranchers/v18/zrfm0H3Lx-P2Xvs2ArDfBi8.woff2"
      }
    }
  },
